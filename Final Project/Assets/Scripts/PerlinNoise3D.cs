...
public static class PerlinNoise3D
{
	...
	private const int _directionCount = 15;
	...
	public static float PerlinNoise(Vector3 point, float frequency)
	{
		point *= frequency;
		...
		flooredPointX0 &= _permutationCount;
		flooredPointY0 &= _permutationCount;
		flooredPointZ0 &= _permutationCount;
        ...
        */
		Vector3 direction000 = _directions[_permutation[permutationY00 + flooredPointZ0] & _directionCount];
		Vector3 direction100 = _directions[_permutation[permutationY10 + flooredPointZ0] & _directionCount];
		Vector3 direction010 = _directions[_permutation[permutationY01 + flooredPointZ0] & _directionCount];
		Vector3 direction110 = _directions[_permutation[permutationY11 + flooredPointZ0] & _directionCount];
		Vector3 direction001 = _directions[_permutation[permutationY00 + flooredPointZ1] & _directionCount];
		Vector3 direction101 = _directions[_permutation[permutationY10 + flooredPointZ1] & _directionCount];
		Vector3 direction011 = _directions[_permutation[permutationY01 + flooredPointZ1] & _directionCount];
		Vector3 direction111 = _directions[_permutation[permutationY11 + flooredPointZ1] & _directionCount];
