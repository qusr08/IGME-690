...
public class ProceduralMeshComponent : MonoBehaviour
{
    ...
    private List<TriangleNode> CalculateTriangleNeighbors(Mesh mesh)
    {
        ...
        Dictionary<Edge, List<TriangleNode>> edges = new Dictionary<Edge, List<TriangleNode>>();
        ...
        for (int i = 0; i < mesh.triangles.Length; i += 3)
        {
            ...
            TryAddConnection(ref edges, new Edge(index1, index2), triangle);
            TryAddConnection(ref edges, new Edge(index2, index3), triangle);
            TryAddConnection(ref edges, new Edge(index3, index1), triangle);
        }

        return triangles;
    }

    private void TryAddConnection(ref Dictionary<Edge, List<TriangleNode>> edges, Edge edge, TriangleNode triangle)
    {
